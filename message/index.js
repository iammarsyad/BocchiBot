...
module.exports = msgHandler = async (bocchi = new Client(), message) => {
    try {
        ...
        if (chats == 'p'){
        if (!isGroupMsg) 
        aruga.reply(from, `Halo Kak, Untuk Memulai bot silahkan ketik ${prefix}menu`, id)
        }  
       ...
       if (!isGroupMsg) 
       aruga.reply(from, `Waalaikumsalam , Halo Kak, Untuk Memulai bot silahkan ketik ${prefix}menu`, id)
       }
